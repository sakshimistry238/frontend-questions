...
import type { ISignupForm } from "../../../service/store/auth/types";
import { joiResolver } from "@hookform/resolvers/joi";
import { SignupVelidation } from "../../../utils/constants/form-validation";
...
export const Signup = () => {
  ...
  const {
    ...
    resolver: joiResolver(SignupVelidation),
  });
          ...
          <form className="space-y-6" onSubmit={handleSubmit(handleFormData)}>
            <div>
              ...
              <div className="mt-1">
                ...
                {errors?.firstName && (
                  <div
                    className="flex items-center pt-2 text-sm text-red-600/90 rounded-lg"
                    role="alert"
                  >
                    <svg
